          ...
          <nav className="flex flex-col gap-1 text-sm text-[var(--muted)]">
            ...
            {travelOpen && (
              <div className="ml-4 flex flex-col gap-1 border-l border-[var(--border)] pl-4">
                <Link href="/travel/essentials" onClick={closeAll} className="rounded-xl px-3 py-2.5 hover:bg-black/5 hover:text-[var(--text)]">
                  Essentials
                </Link>
                <Link href="/travel/destinations" onClick={closeAll} className="rounded-xl px-3 py-2.5 hover:bg-black/5 hover:text-[var(--text)]">
                  Destinations
                </Link>
                <Link href="/travel/stories" onClick={closeAll} className="rounded-xl px-3 py-2.5 hover:bg-black/5 hover:text-[var(--text)]">
                  Stories
                </Link>
                <Link href="/travel/photos" onClick={closeAll} className="rounded-xl px-3 py-2.5 hover:bg-black/5 hover:text-[var(--text)]">
                  Photos
                </Link>
              </div>
            )}
